...
$routes->group('admin/sekretariat', ['filter' => 'adminrole:sekretariat'], static function ($routes): void {
    ...
    // Sertifikat Batch (menu Tools → akses sekretariat / super_admin)
    $routes->get('sertifikat-batch', 'Admin\PrinterController::cetakBatchList');
    $routes->post('sertifikat-batch/proses-cetak', 'Admin\PrinterController::prosesCetakBatch');
    $routes->post('sertifikat-batch/proses-cetak-local', 'Admin\PrinterController::prosesCetakBatchLocal');
});
...
$routes->group('admin/printer', ['filter' => 'adminrole:printer'], static function ($routes): void {
    ...
    // Batch cetak sertifikat (render lokal + browser)
    $routes->get('cetak-batch', 'Admin\PrinterController::cetakBatchList');
    $routes->post('proses-cetak-batch', 'Admin\PrinterController::prosesCetakBatch');
    $routes->post('proses-cetak-batch-local', 'Admin\PrinterController::prosesCetakBatchLocal');
