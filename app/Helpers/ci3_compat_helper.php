...
if (! function_exists('online_asset')) {
    ...
    function online_asset(string $key): string
    {
        $assets = [
            ...
            'datatables_buttons_html5_js'  => 'https://cdn.datatables.net/buttons/2.4.2/js/buttons.html5.min.js',
            'datatables_buttons_print_js'  => 'https://cdn.datatables.net/buttons/2.4.2/js/buttons.print.min.js',
            'datatables_buttons_colvis_js' => 'https://cdn.datatables.net/buttons/2.4.2/js/buttons.colVis.min.js',
            'jszip_js'                     => 'https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js',
