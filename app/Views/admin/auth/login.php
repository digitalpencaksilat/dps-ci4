            ...
            <div class="col-lg-5 d-flex align-items-center justify-content-center px-4 px-lg-5 py-5 bg-white">
                <div class="auth-card w-100">
                    <div class="text-center mb-4">
                        ...
                        <h1 class="auth-title mb-2">Masuk ke Panel Admin</h1>
                    ...
                    <div class="text-center mt-4 small text-muted">
                        ...
                        <a href="<?= base_url('pendaftaran/login') ?>" class="text-brand fw-semibold text-decoration-none">portal kontingen</a>
                    </div>
                </div>
            </div>
                ...
                <section class="login-hero-card w-100">
                    ...
                    <div class="hero-content">
                        <p class="eyebrow text-white-50">Digital Pencak Silat</p>
                         <h2 class="hero-title text-white">Panel admin fokus ke validasi pembayaran, rekap kontingen, dan alur kerja yang lebih cepat.</h2>
