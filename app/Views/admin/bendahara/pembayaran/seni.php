...
<section class="admin-card">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
        <div>
            <p class="eyebrow mb-1">Riwayat Seni</p>
            <h3 class="section-title h4 mb-0">Pembayaran seni</h3>
            <p class="muted-copy mb-0 mt-2">Lihat nomor seni yang sudah terhubung ke transaksi atau masih belum dibayar.</p>
        </div>
    ...
    <?php if (($rows ?? []) === []) : ?>
        <div class="placeholder-stat">
            <h4 class="h5 mb-2">Belum ada data seni</h4>
            <p class="muted-copy mb-0">Riwayat pembayaran seni akan tampil setelah kelompok seni terhubung ke transaksi.</p>
        </div>
    <?php else : ?>
