            ...
            <table class="table admin-table align-middle mb-0 w-100" id="tableCetakSeni">
                ...
                <tbody>
                    <?php foreach ($data as $p) : ?>
                        ...
                        $showPool = ($p->sistem_penampilan ?? '') === 'pool' && ($p->nomor_pool ?? null) !== null && $p->nomor_pool !== '';
                        ...
                        <tr>
                            ...
                            <td class="d-none d-lg-table-cell text-capitalize small">
                                <?= esc($seniLabel) ?>
                                <?php if ($showPool) : ?>
                            ...
                            <td data-order="<?= esc((string) ($p->nomor_sertifikat ?? ''), 'attr') ?>">
                                ...
                                <?php if (! $p->nomor_sertifikat) : ?>
                                    <button type="button" class="btn btn-sm btn-link p-0 ms-1 btn-generate-nomor"
                                        data-jenis="seni" data-id="<?= esc((string) $p->id_peserta_seni, 'attr') ?>"
...
<script>
    initPrinterCetakTable('#tableCetakSeni');
</script>
<?= $this->endSection() ?>
