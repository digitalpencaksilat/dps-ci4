<?php
/**
 * Cetak bagan seni battle (parity CI3 print/bagan/seni/bagan_per_kategori_lomba).
 *
...
<head>
    <meta charset="UTF-8">
    <title><?= esc($eventName ?? 'Bagan Seni Battle') ?> - Bagan Seni Battle</title>
...
<body>
    ...
    <div class="container-fluid">
        <?php if ($groups === []) : ?>
            <div class="text-center py-5"><h4>Tidak ada bagan seni battle untuk dicetak.</h4></div>
        <?php endif; ?>
        ...
        <?php foreach ($groups as $group) : $meta = $group['meta']; ?>
            <div class="row justify-content-center cover min-vh-100 align-content-center">
                ...
                <div class="col-10 mt-5 text-center">
                    <h5 class="h1">Artistic Match Bracket</h5>
                    ...
                    <div class="col-12">
                        <div class="row mb-3 justify-content-center bracket-header mx-0 shadow-sm">
                            ...
                            <div class="col-10 head-title py-3 text-center">
                                <p class="h6 mb-1"><?= esc($eventName ?? '') ?> &mdash; Artistic Bracket</p>
                                <p class="h3 m-0 fw-bolder">
                                    <?= esc(($kompetisi->nama_kategori_usia ?? '') . ' ' . ucwords((string) ($kompetisi->jenis_kelamin ?? '')) . ' - ' . ucwords((string) ($kompetisi->jenis_seni ?? '')) . ' ' . (string) ($kompetisi->nama_seni ?? '')) ?>
                        ...
                        <div class="row py-2 px-4">
                            <div class="col-12 p-3 shadow-sm border rounded">
                                <?= view('shared_components/kompetisi_seni/bagan_battle_seni', ['kompetisi_seni' => $kompetisi, 'toggle_early_match' => false]) ?>
                            </div>
                        </div>
                    </div>
                </div>
