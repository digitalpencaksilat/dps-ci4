...
<style>
:root{--schedule-ink:#0f172a;--schedule-muted:rgba(15,23,42,.62);--schedule-line:rgba(15,23,42,.10);--schedule-soft:rgba(198,0,0,.10);--schedule-accent:var(--brand-primary,#c60000);--schedule-sky:var(--admin-accent-dark,#8f0b14);}
