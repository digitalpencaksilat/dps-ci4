...
<head>
	...
	<title>
		Match Bracket - <?php echo $kompetisi_tanding->nama_kategori_usia . ' ' . $kompetisi_tanding->jenis_kelamin . ' ' . $kompetisi_tanding->label . ' Pool ' . $kompetisi_tanding->nomor_pool ?>
	</title>
...
<body>
	...
	<div class="container-fluid">
		<?= view('print/bagan/tanding/components/header' ) ?>
		
		<div class="card shadow-sm border-0 mb-5">
			<div class="card-body p-0">
				<?= view('shared_components/kompetisi_tanding/bagan_pertandingan' ) ?>
			</div>
		</div>
	</div>
