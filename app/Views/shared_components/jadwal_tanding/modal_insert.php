<button type="button" class="btn btn-outline-primary mb-4 mt-0" data-bs-toggle="modal" data-bs-target="#modalInsertJadwalTanding">
	Create Schedule
</button>
<div class="modal fade" id="modalInsertJadwalTanding" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?= base_url('jadwal-tanding/create') ?>" novalidate="novalidate" id="formInsertJadwalTanding" class="needs-validation" method="post" accept-charset="utf-8">
				...
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<input type="date" class="form-control" name="tanggal" id="tanggal" required aria-describedby="helpTanggal" placeholder="Date">
