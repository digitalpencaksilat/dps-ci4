...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm rounded-4">
        ...
        <?php if (session()->get('level') === 'super_admin'): ?>
            ...
            <li>
                <form action="<?= base_url($routePrefix . '/' . $jadwal->id_jadwal_tanding . '/delete') ?>" method="post" onsubmit="return confirmAdminAction(this, 'Hapus Jadwal Tanding?', 'Schedule akan dihapus permanen.', 'Ya, Hapus')">
                    <?= csrf_field() ?>
