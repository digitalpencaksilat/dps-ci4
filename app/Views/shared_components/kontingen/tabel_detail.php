								...
								$(win.document.body).prepend(
									`<?php
										$this->load->view(
											...
											['header_title' => 'DATA KONTINGEN', 'header_subtitle' => get_instance()->get_setting('event_name')],
											FALSE
										);
										?>`
								);
    ...
    `;
						...
						},
						{
							...
							customize: function(xlsx) {
								...
								$(colElement).append('<col min="2" max="2" width="45" customWidth="1"/>'); // Nama (B) - Diperlebar
								$(colElement).append('<col min="3" max="3" width="30" customWidth="1"/>'); // Kontingen (C)
								$(colElement).append('<col min="4" max="4" width="25" customWidth="1"/>'); // Nama Sekolah (D)
								$(colElement).append('<col min="5" max="5" width="30" customWidth="1"/>'); // Kategori (E)
								$(colElement).append('<col min="6" max="6" width="30" customWidth="1"/>'); // Kelas (F)
								$(colElement).append('<col min="7" max="7" width="30" customWidth="1"/>'); // Nama Sekolah (D)
								$(colElement).append('<col min="8" max="8" width="30" customWidth="1"/>'); // Kategori (E)
								$(colElement).append('<col min="9" max="9" width="30" customWidth="1"/>'); // Kelas (F)
