...
const swalDefaultConfiguration = Swal.mixin({
	customClass: {
...
function initNavs() {
  total.forEach(function(item, i) {
    ...
    moving_div.style.zIndex = 100;
    moving_div.style.visibility = 'visible';
    moving_div.style.padding = '0px';
    moving_div.style.width = item.querySelector('li:nth-child(1)').offsetWidth + 'px';
    moving_div.style.height = item.querySelector('li:nth-child(1)').offsetHeight + 'px';
      ...
      if (li) {
        ...
        item.querySelector('li:nth-child(' + index + ') .nav-link').onclick = function() {
          ...
          if (item.classList.contains('flex-column')) {
            ...
            moving_div.style.height = item.querySelector('li:nth-child(' + index + ')').offsetHeight + 'px';
          }
        }
      }
    }
