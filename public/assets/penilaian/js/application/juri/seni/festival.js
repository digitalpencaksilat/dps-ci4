const juri = {
  ...
  edit_nilai_kebenaran_jurus: function (
    ...
    $input_elemment = $($element)
      .parents(".container_" + $jurus + "_" + $nomor_rangkaian_gerak)
      .find("input");
    $nilai_maksimal = parseInt(
      juri.data_nilai.penilaian.unsur_nilai.kebenaran.jurus[$jurus]
        .rangkaian_gerak[$nomor_rangkaian_gerak].nilai_maksimal
    );
    $jumlah_kesalahan_selanjutnya =
      parseInt($input_elemment.val()) + parseInt($perubahan);
    if (
      ...
      juri.data_nilai.penilaian.unsur_nilai.kebenaran.jurus[
        $jurus
      ].rangkaian_gerak[$nomor_rangkaian_gerak].jumlah_kesalahan += $perubahan;
      juri.data_nilai.penilaian.unsur_nilai.kebenaran.jurus[
        $jurus
      ].rangkaian_gerak[$nomor_rangkaian_gerak].nilai_diperoleh -= $perubahan;
      juri.data_nilai.penilaian.unsur_nilai.kebenaran.nilai_diperoleh -=
        $perubahan;
      juri.data_nilai.penilaian.unsur_nilai.kebenaran.total_kesalahan_gerak +=
        $perubahan;
  ...
  edit_unsur_nilai_pilihan_ganda: function (
    $jenis_unsur_nilai,
    $data,
    $element
  ) {
    ...
    juri.data_nilai.penilaian.unsur_nilai[$jenis_unsur_nilai].nilai_diperoleh =
      $data.bobot_nilai;
    juri.data_nilai.penilaian.unsur_nilai[
      $jenis_unsur_nilai
    ].metadata.terpilih = $data.terpilih;
        ...
        $.each(
          ...
          function (key_jenis_unsur_seni, value_jenis_unsur_seni) {
            if (key_jenis_unsur_seni == "kebenaran") {
              ...
              $(".total_kesalahan_gerak").html(
                value_jenis_unsur_seni.total_kesalahan_gerak
              );
