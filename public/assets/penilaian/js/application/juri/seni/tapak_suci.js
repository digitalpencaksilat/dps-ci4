const juri = {
	...
	edit_unsur_nilai: function ($jenis_unsur_nilai, $perubahan, $element) {
		/**
		* @params $perubahan int penambah bisa berupa 1, -1, atau 5, -5 atau berapapun
		* @params $element DOM
		...
		*/
		...
		$nilai_setelah_input = parseInt($input_elemment.val()) + parseInt($perubahan);
		if (
			$nilai_setelah_input <= $nilai_maksimal &&
			$nilai_setelah_input >= $nilai_minimal) {
