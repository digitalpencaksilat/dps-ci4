...
const ketua_pertandingan = {
	...
	set_variable: function ($data_nilai, $pertandingan, $verifikasi_pertandingan_berlangsung, $riwayat_verifikasi_pertandingan, jawaban_riwayat_verifikasi_pertandingan) {
		ketua_pertandingan.data_nilai = $data_nilai;
		ketua_pertandingan.pertandingan = $pertandingan;
		ketua_pertandingan.verifikasi_pertandingan_berlangsung = $verifikasi_pertandingan_berlangsung;
		ketua_pertandingan.riwayat_verifikasi_pertandingan = $riwayat_verifikasi_pertandingan;
		ketua_pertandingan.jawaban_riwayat_verifikasi_pertandingan = $jawaban_riwayat_verifikasi_pertandingan;
		...
		if ($pertandingan.ringkasan_nilai !== undefined) {
			ketua_pertandingan.ringkasan_nilai = JSON.parse($pertandingan.ringkasan_nilai);
		}
	...
	update_tampilan_nilai: function () {
		...
		$.each(ketua_pertandingan.data_nilai['juri'], function (key, perangkat_pertandingan) {
				...
				$.each(nilai_sudut.ronde_pertandingan, function (index_ronde, nilai_ronde) {
					...
					if (jumlah_rincian_nilai > 0) {
						$.each(nilai_ronde['rincian'], function (index, nilai) {
							$timestamp = ketua_pertandingan.get_timestamp(nilai['timestamp']);
							...
							if (nilai.is_deleted === true) {
								...
								if (nilai['nilai'] > 0 && nilai['nilai'] < 3) {
									...
									$rincian_nilai_per_ronde += '<span class="fw-lighter text-decoration-line-through px-2 py-1 d-inline-block" data-bs-toggle="popover" data-bs-placement="top" title="deleted at ' + ketua_pertandingan.get_timestamp(nilai.deleted_at) + '" style="color: #999999 !important;">' + nilai['nilai'] + '</span>';
								} else if (nilai['nilai'] == 3) {
									// Jatuhan
									$rincian_jatuhan_per_ronde += '<span class="fw-lighter text-decoration-line-through px-2 py-1 d-inline-block" data-bs-toggle="popover" data-bs-placement="top" title="deleted at ' + ketua_pertandingan.get_timestamp(nilai.deleted_at) + '" style="color: #999999 !important;">' + nilai['nilai'] + '</span>';
								} else if (nilai['nilai'] < 0) {
									// Hukuman
									$rincian_hukuman_per_ronde += '<span class="fw-lighter text-decoration-line-through px-2 py-1 d-inline-block" data-bs-toggle="popover" data-bs-placement="top" title="deleted at ' + ketua_pertandingan.get_timestamp(nilai.deleted_at) + '" style="color: #999999 !important;">' + nilai['nilai'] + '</span>';
								}
							...
							if (nilai['nilai'] > 0 && nilai['nilai'] < 3) {
								...
								if (nilai['status'] == 'input' || nilai['status'] == 'verified' && nilai['warna'] == null) {
									$rincian_nilai_per_ronde += '<span class="fw-lighter text-decoration-line-through px-2 py-1 d-inline-block" data-bs-toggle="popover" data-bs-placement="top" title="' + nilai['status'] + ' == ' + nilai['id_nilai'] + ' - ' + $timestamp + '">' + nilai['nilai'] + '</span>';
								} else {
									$rincian_nilai_per_ronde += '<span class="text-white px-2 py-1 d-inline-block" style="background-color:' + nilai['warna'] + '" data-bs-toggle="popover" data-bs-placement="top" title="' + nilai['status'] + ' == ' + nilai['id_nilai'] + ' - ' + $timestamp + '" >' + nilai['nilai'] + '</span>';
								}
							} else if (nilai['nilai'] == 3) {
								// Hanya menampilkan poin Jatuhan
								$rincian_jatuhan_per_ronde += '<span class="px-2 py-1 d-inline-block">' + nilai['nilai'] + '</span>';
							} else if (nilai['nilai'] < 0) {
								$rincian_hukuman_per_ronde += '<span class="fw-lighter  px-2 py-1 d-inline-block">' + nilai['nilai'] + '</span>';
							}
						});
					}
					...
					$('.ronde-' + index_ronde + '-' + 'juri-' + perangkat_pertandingan.id_perangkat_pertandingan + '-nilai-' + key_sudut).html($rincian_nilai_per_ronde);
					$('.ronde-' + index_ronde + '-' + key_sudut + '-rincian-nilai-jatuhan').html($rincian_jatuhan_per_ronde);
					$('.ronde-' + index_ronde + '-' + key_sudut + '-rincian-nilai-hukuman').html($rincian_hukuman_per_ronde);
					$('.ronde-' + index_ronde + '-' + 'juri-' + perangkat_pertandingan.id_perangkat_pertandingan + '-nilai-akhir-' + key_sudut).html('<span class="text-white">' + nilai_ronde['ringkasan']['nilai_akhir'] + '</span>');
				});

				// Nilai semua babak (tampilan utama KP khusus penilaian 2022)
				$('.juri-' + perangkat_pertandingan.id_perangkat_pertandingan + '-nilai-' + key_sudut).empty().append($rincian_nilai_semua_ronde);
				$('.semua-ronde-' + key_sudut + '-rincian-nilai-jatuhan').empty().html($rincian_jatuhan_semua_ronde);
				$('.semua-ronde-' + key_sudut + '-rincian-nilai-hukuman').empty().html($rincian_hukuman_semua_ronde);
			});
		});
		...
		$.each(ketua_pertandingan.data_nilai['penilaian_verified'], function (sudut, penilaian) {
			$('.' + sudut + '-nilai-verified').empty();
			$rincian_nilai = { "semua_ronde": [], "per_ronde": { "1": {}, "2": {}, "3": {} } };

			$.each(penilaian, function (i, isi_nilai) {
				if (isi_nilai[0]['entry_nilai']['nilai'] > 0 && isi_nilai[0]['entry_nilai']['nilai'] < 3) {
					$rincian_nilai["semua_ronde"].push('<span class="text-white px-2 py-1 d-inline-block" style="background-color:' + isi_nilai[0]['entry_nilai']['warna'] + '">' + isi_nilai[0]['entry_nilai']['nilai'] + '</span>');

					$rincian_nilai["per_ronde"][isi_nilai[0]['ronde']][i] = '<span class="text-white px-2 py-1 d-inline-block" style="background-color:' + isi_nilai[0]['entry_nilai']['warna'] + '">' + isi_nilai[0]['entry_nilai']['nilai'] + '</span>';
				}
			});

			$.each($rincian_nilai["per_ronde"], function (ronde, kumpulan_nilai_per_ronde) {
				$('.ronde-' + ronde + '-' + sudut + '-nilai-verified').empty();
				$.each(kumpulan_nilai_per_ronde, function (i, nilai) {
					$('.ronde-' + ronde + '-' + sudut + '-nilai-verified').append(nilai);
				});
			});
		...
		$.each(ketua_pertandingan.data_nilai['ringkasan']['per_ronde'], function (index_ronde, nilai_per_ronde) {
			$.each(nilai_per_ronde, function (index_sudut, nilai_sudut) {
				// Set Total Nilai Sah Pukulan Tendangan Per Ronde
				$pukulan_tendangan = (nilai_sudut['pukulan'] + (nilai_sudut['tendangan'] * 2));
				$('.ronde-' + index_ronde + '-' + index_sudut + '-pukulan-tendangan').html($pukulan_tendangan);

				// Set Total Nilai Sah Jatuhan Per Ronde
				$jatuhan = (nilai_sudut['jatuhan'] * 3);
				$('.ronde-' + index_ronde + '-' + index_sudut + '-total-jatuhan').html($jatuhan);
				...
				$('.ronde-' + index_ronde + '-' + index_sudut + '-total-hukuman').html($hukuman);

				$('.ronde-' + index_ronde + '-' + index_sudut + '-nilai-akhir').html(nilai_sudut['nilai_akhir']);
			});
		});
		...
		$.each(ketua_pertandingan.data_nilai['ringkasan']['per_ronde'], function (index_ronde, nilai_per_ronde) {
			$.each(nilai_per_ronde, function (index_sudut, nilai_sudut) {
				...
				if (nilai_sudut['binaan_1'] !== 0) {
					$('.ronde-' + index_ronde + '-' + index_sudut + '-binaan').append('<span class="me-3 badge bg-warning px-2 py-1 text-white">Binaan 1</span>');
					$('.semua-ronde-' + index_sudut + '-binaan').append('<span class="me-3 badge bg-warning px-2 py-1 text-white">Ronde ' + index_ronde + ' - Binaan 1</span>');
				}

				if (nilai_sudut['binaan_2'] !== 0) {
					$('.ronde-' + index_ronde + '-' + index_sudut + '-binaan').append('<span class="me-3 badge bg-warning px-2 py-1 text-white">Binaan 2</span>');
					$('.semua-ronde-' + index_sudut + '-binaan').append('<span class="me-3 badge bg-warning px-2 py-1 text-white">Ronde ' + index_ronde + ' - Binaan 2</span>');
				}
				// End Of Binaan
			});
		});
		...
		$.each(ketua_pertandingan.data_nilai['ringkasan']['semua_ronde'], function (index_sudut, nilai_sudut) {
			// Set Total Nilai Sah Pukulan Tendangan Semua Ronde
			$pukulan_tendangan = (nilai_sudut['pukulan'] + (nilai_sudut['tendangan'] * 2));
			$('.semua-ronde-' + index_sudut + '-pukulan-tendangan').html($pukulan_tendangan);
		...
		$('#skor_merah, .skor_merah').html(ketua_pertandingan.pertandingan.skor_merah);
		$('#skor_biru, .skor_biru').html(ketua_pertandingan.pertandingan.skor_biru);
		$('.ronde_pertandingan').html('Round ' + ketua_pertandingan.ronde_pertandingan);

		ketua_pertandingan.highlight_nilai_akhir();

		// BLOK KODE UNTUK MENGUNCI TOMBOL HUKUMAN
		$.each(ketua_pertandingan.data_nilai['ringkasan']['per_ronde'][ketua_pertandingan.ronde_pertandingan], function (index_sudut, nilai_sudut) {
			// Set Hukuman
			...
			if (nilai_sudut['teguran_1'] == 1) {
				...
				if (nilai_sudut['teguran_2'] == 0) {
					...
					$('.btn-teguran-1-' + index_sudut).on('click', function (e) {
						ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'teguran_1', 'hapus', this)
					});
				}
			} else {
				//JIKA teguran 1 OFF
				$('.btn-teguran-1-' + index_sudut).addClass('opacity-3');
				$('.btn-teguran-1-' + index_sudut).off('click').on('click', function (e) {
					ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'hukuman', -1, this)
				});
			}

			if (nilai_sudut['teguran_2'] == 1) {
				$('.btn-teguran-2-' + index_sudut).removeClass('opacity-3');
				$('.btn-teguran-2-' + index_sudut).off('click').on('click', function (e) {
					ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'teguran_2', 'hapus', this)
				});
			} else {
				...
				if (nilai_sudut['teguran_1'] == 1) {
					...
					$('.btn-teguran-2-' + index_sudut).on('click', function (e) {
						ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'hukuman', -2, this)
					});
				}
			}
			...
			if (nilai_sudut['binaan_1'] == 1) {
				...
				if (nilai_sudut['binaan_2'] == 0) {
					...
					$('.btn-binaan-1-' + index_sudut).on('click', function (e) {
						ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'binaan_1', 'hapus', this)
					});
				}
			} else {
				//JIKA binaan 1 OFF
				$('.btn-binaan-1-' + index_sudut).addClass('opacity-3');
				$('.btn-binaan-1-' + index_sudut).off('click').on('click', function (e) {
					ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'binaan', 1, this)
				});
			}

			if (nilai_sudut['binaan_2'] == 1) {
				$('.btn-binaan-2-' + index_sudut).removeClass('opacity-3');
				$('.btn-binaan-2-' + index_sudut).off('click').on('click', function (e) {
					ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'binaan_2', 'hapus', this)
				});
			} else {
				...
				if (nilai_sudut['binaan_1'] == 1) {
					...
					$('.btn-binaan-2-' + index_sudut).on('click', function (e) {
						ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'binaan', 2, this)
					});
				}
			}
			// END OF BLOK binaan
		...
		$.each(ketua_pertandingan.data_nilai['ringkasan']['semua_ronde'], function (index_sudut, nilai_sudut) {
			...
			if (nilai_sudut['peringatan_1'] == 1) {
				...
				if (nilai_sudut['peringatan_2'] == 0) {
					...
					$('.btn-peringatan-1-' + index_sudut).on('click', function (e) {
						ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'peringatan_1', 'hapus', this)
					});
				}
			} else {
				//JIKA peringatan 1 OFF
				$('.btn-peringatan-1-' + index_sudut).addClass('opacity-3');
				$('.btn-peringatan-1-' + index_sudut).off('click').on('click', function (e) {
					ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'hukuman', -5, this)
				});
			...
			if (nilai_sudut['peringatan_2'] == 1) {
				...
				$('.btn-peringatan-2-' + index_sudut).off('click').on('click', function (e) {
					ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'peringatan_2', 'hapus', this)
				});
			} else {
				...
				if (nilai_sudut['peringatan_1'] == 1) {
					...
					$('.btn-peringatan-2-' + index_sudut).on('click', function (e) {
						ketua_pertandingan.edit_penilaian_tanding(index_sudut, 'hukuman', -10, this)
					});
				}
			}
	...
	update_tampilan_riwayat_verifikasi: function () {
		...
		$.each(ketua_pertandingan.riwayat_verifikasi_pertandingan, function (i, verifikasi_pertandingan) {
			if (typeof ketua_pertandingan.jawaban_riwayat_verifikasi_pertandingan[verifikasi_pertandingan.id_verifikasi_pertandingan] != 'undefined') {

				$jenis_verifikasi = (verifikasi_pertandingan.jenis_verifikasi == 'jatuhan') ? 'Dropping' : "Violation";
				if(verifikasi_pertandingan.status == 'batal'){
					$jenis_verifikasi += '<br> (canceled)'
				}
				$row = `
					<tr class="text-white text-center">
						<td class="align-middle bg-white text-dark">`+ verifikasi_pertandingan.ronde_pertandingan + `</td>
						<td class="align-middle bg-white text-dark">`+ Math.floor((verifikasi_pertandingan.waktu / 1000) / 60) + `:` + ((verifikasi_pertandingan.waktu / 1000) % 60).toString().padStart(2, '0') + `</td>
						<td class="align-middle bg-white text-dark">`+ verifikasi_pertandingan.timestamp + `</td>
						<td class="align-middle bg-white text-dark">`+ $jenis_verifikasi + `</td>
						`+ ketua_pertandingan.ubah_warna_sudut_ke_td(ketua_pertandingan.jawaban_riwayat_verifikasi_pertandingan[verifikasi_pertandingan.id_verifikasi_pertandingan][0].jawaban) + `
						`+ ketua_pertandingan.ubah_warna_sudut_ke_td(ketua_pertandingan.jawaban_riwayat_verifikasi_pertandingan[verifikasi_pertandingan.id_verifikasi_pertandingan][1].jawaban) + `
						`+ ketua_pertandingan.ubah_warna_sudut_ke_td(ketua_pertandingan.jawaban_riwayat_verifikasi_pertandingan[verifikasi_pertandingan.id_verifikasi_pertandingan][2].jawaban) + `
						`+ ketua_pertandingan.ubah_warna_sudut_ke_td(verifikasi_pertandingan.hasil_verifikasi) + `
					</tr>
				`;
				$('#tabel_riwayat_verifikasi_pertandingan').find('tbody').append($row);
			}
		});
	...
	update_tampilan_ringkasan_nilai : function(){
		...
		$.each(ketua_pertandingan.data_nilai['ringkasan']['semua_ronde'], function (index_sudut, nilai_sudut) {
			...
			$.each(nilai_sudut, function (jenis_ringkasan_nilai, bobot_nilai) { 
				 $('.ringkasan_nilai_'+index_sudut+'_'+jenis_ringkasan_nilai).html(bobot_nilai);
			});
		});
	},
	...
	highlight_nilai_akhir: function () {
		ketua_pertandingan.pertandingan.skor_merah = parseInt(ketua_pertandingan.pertandingan.skor_merah);
		ketua_pertandingan.pertandingan.skor_biru = parseInt(ketua_pertandingan.pertandingan.skor_biru);
		if (ketua_pertandingan.pertandingan.skor_biru > ketua_pertandingan.pertandingan.skor_merah) {
			// Merah Menang
			ketua_pertandingan.highlight_nilai_sudut('biru');
		} else if (ketua_pertandingan.pertandingan.skor_biru < ketua_pertandingan.pertandingan.skor_merah) {
			// Biru Menang
	...
	highlight_nilai_sudut: function ($sudut) {
		...
		if ($sudut == 'biru') {
			$('#skor_biru').parent().removeClass('bg-gradient-180-gray-dark').addClass('bg-gradient-180-blue');
			$('#skor_merah').parent().removeClass('bg-gradient-180-red').addClass('bg-gradient-180-gray-dark');
		} else if ($sudut == 'merah') {
			$('#skor_biru').parent().removeClass('bg-gradient-180-blue').addClass('bg-gradient-180-gray-dark');
			$('#skor_merah').parent().removeClass('bg-gradient-180-gray-dark').addClass('bg-gradient-180-red text-white');
		} else {
			$('#skor_biru').parent().removeClass('bg-gradient-180-blue').addClass('bg-gradient-180-gray-dark');
			$('#skor_merah').parent().removeClass('bg-g radient-180-red').addClass('bg-gradient-180-gray-dark');
		}
	},
	edit_penilaian_tanding: function ($sudut, $mode = 'jatuhan', $jumlah, $btn = null) {
		...
		$.post("ketua-pertandingan/edit-penilaian-tanding/" + ketua_pertandingan.id_pertandingan,
			...
			function (data, textStatus, jqXHR) {
				if (data.status === false) {
					...
					ketua_pertandingan.set_variable(data.data_nilai, data.pertandingan, data.riwayat_verifikasi_pertandingan);
					ketua_pertandingan.update_tampilan_nilai();
					ketua_pertandingan.update_timer();
				}
			},
	...
	modalVerifikasiJatuhan: ($('#modalVerifikasiJatuhan').length > 0) ? new bootstrap.Modal(document.getElementById('modalVerifikasiJatuhan'), {
		keyboard: false
	}) : null,
	modalVerifikasiPelanggaran: ($('#modalVerifikasiPelanggaran').length > 0) ? new bootstrap.Modal(document.getElementById('modalVerifikasiPelanggaran'), {
		keyboard: false
	}) : null,
	verifikasi_jatuhan: function () {
		waitingDialog.show('Starting Drop Verification..');
		$.post("verifikasi-pertandingan/create/" + ketua_pertandingan.id_pertandingan,
			{
	...
	highlight_jawaban_verifikasi_jatuhan: function ($id_verifikasi_pertandingan) {
		$.getJSON("verifikasi-pertandingan/get-jawaban-verifikasi-pertandingan/" + $id_verifikasi_pertandingan,
			function (data, textStatus, jqXHR) {
				if (data.data_jawaban_verifikasi_pertandingan !== null) {

					$modal = $(ketua_pertandingan.modalVerifikasiJatuhan._element);
					$.each(data.data_jawaban_verifikasi_pertandingan, function (i, jawaban_verifikasi_pertandingan) {
	...
	highlight_jawaban_verifikasi_pelanggaran: function ($id_verifikasi_pertandingan) {
		$.getJSON("verifikasi-pertandingan/get-jawaban-verifikasi-pertandingan/" + $id_verifikasi_pertandingan,
			function (data, textStatus, jqXHR) {
				if (data.data_jawaban_verifikasi_pertandingan !== null) {
	...
	periksa_sistem_dialog: function () {
		if (ketua_pertandingan.verifikasi_pertandingan_berlangsung == null || ketua_pertandingan.verifikasi_pertandingan_berlangsung == undefined) {
			if (ketua_pertandingan.modalVerifikasiJatuhan != null) {
			...
			if (ketua_pertandingan.verifikasi_pertandingan_berlangsung.jenis_verifikasi == 'jatuhan') {
				if (ketua_pertandingan.modalVerifikasiJatuhan != null && ketua_pertandingan.modalVerifikasiJatuhan._isShown == false) {
					ketua_pertandingan.open_modal_verifikasi_jatuhan();
				}
				// Highlight setiap kali refresh
				if (ketua_pertandingan.modalVerifikasiJatuhan != null) {
					ketua_pertandingan.highlight_jawaban_verifikasi_jatuhan(ketua_pertandingan.verifikasi_pertandingan_berlangsung.id_verifikasi_pertandingan);
				}
			} else if (ketua_pertandingan.verifikasi_pertandingan_berlangsung.jenis_verifikasi == 'pelanggaran') {
				if (ketua_pertandingan.modalVerifikasiPelanggaran != null && ketua_pertandingan.modalVerifikasiPelanggaran._isShown == false) {
					ketua_pertandingan.open_modal_verifikasi_pelanggaran();
				}
				// Highlight setiap kali refresh
				if (ketua_pertandingan.modalVerifikasiPelanggaran != null) {
					ketua_pertandingan.highlight_jawaban_verifikasi_pelanggaran(ketua_pertandingan.verifikasi_pertandingan_berlangsung.id_verifikasi_pertandingan);
				}
			}
		}
	},
	batalkan_verifikasi: function () {
		...
		$.post("verifikasi-pertandingan/update/" + ketua_pertandingan.verifikasi_pertandingan_berlangsung.id_verifikasi_pertandingan,
