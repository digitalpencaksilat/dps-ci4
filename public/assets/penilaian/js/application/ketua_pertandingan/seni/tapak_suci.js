const ketua_pertandingan = {
	...
	init: function ($id_penampilan_seni, $data_nilai, $penampilan_seni_berlangsung, $read_only = true) {
		/**
	...
	refresh_status_seni: () => {
		$.post("ketua-pertandingan/refresh-status-seni/" + ketua_pertandingan.id_penampilan_seni_berlangsung,
